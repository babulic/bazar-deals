...
def hunt_fetch_queries() -> tuple[str, ...]:
    """Marketplace search phrases that can still sit in 15–130 € and clear the net floor.
...
# Cassette games, straps, tees, bags and perfume never clear the net floor on honest comps.
...
def is_high_yield_kind(kind: str, text: str = "") -> bool:
    """True when same-object comps of this kind can still make a net-floor BUY."""
